...
public class ClosestPair {
    ...
    public ClosestPair(ClosestPairPoint pair1, ClosestPairPoint pair2) {
        this.pair1 = pair1;
        this.pair2 = pair2;
    }
    ...
    public static ClosestPair findClosestPair(ArrayList<ClosestPairPoint> pointList) {
    ...
    private static ClosestPair findClosestInSorted(List<ClosestPairPoint> xSortedList, List<ClosestPairPoint> ySortedList) {
        ...
        ClosestPair leftPair = findClosestInSorted(xSortedList.subList(0, mid), yListLeft);
        ClosestPair rightPair = findClosestInSorted(xSortedList.subList(mid,xSortedList.size()), yListRight);
       ...
       for (int i = 0; i < ySortedList.size(); i++) {
        ...
        ClosestPair stripClose = stripClosest(closePoints, delta);
        if (stripClose != null) {
    ...
    private static ClosestPair stripClosest(ArrayList<ClosestPairPoint> strip, double delta) {
        double min = delta;
    ...
    private static ClosestPair bruteForce(List<ClosestPairPoint> pointList) {
